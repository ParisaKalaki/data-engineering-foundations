...
cleaned_and_enriched as (
    select
        ...
        to_hex(md5(concat(cast(u.vendor_id as string), cast(u.pickup_datetime as string), cast(u.pickup_location_id as string), cast(u.service_type as string)))) as trip_id,
